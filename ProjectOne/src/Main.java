...
public class Main {
        public static void main(String[] args) {
                ...
                while (playAgain) {
                        ...
                        // Player(String name, int healthPoints, int strength, int wisdom, int
                        // compassion) {
                        ...
                        Scene scene5 = new Scene(
                                        "You encounter a survivor in distress. How do you help?",
...
// starts the game by calling the startGame method of the Game class, initiating the game loop.
                        game.startGame();
                        ...
                        // scanner.nextLine();
                        // If the player chooses not to play again, the loop is exited using the break statemen
